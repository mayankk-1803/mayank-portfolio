...
const Contact = () => {
    ...
    emailjs
      .sendForm('service_u30eop8', 'template_4loy63j', formRef.current, {
        publicKey: '4-L6I6IJun2yYLJxR',
      })
      .then(
        (result) => {
          setSuccess(true)
    ...
    >
      <motion.div className="textContainer" variants={variants}>
        ...
        <motion.div className="item" variants={variants}>
          <h2>Mail</h2>
          <span>mayankmathur183@gmail.com</span>
        </motion.div>
        <motion.div className="item" variants={variants}>
          <h2>Phone</h2>
          <span>+91 9258337170</span>
        </motion.div>
      </motion.div>
      <div className="formContainer">
        ...
        <motion.form onSubmit={sendEmail} ref={formRef} initial={{opacity:0}} whileInView={{opacity:1}} transition={{delay:4,duration:1}}>
          ...
          <textarea rows={8} placeholder="Leave a message" name="message" />
